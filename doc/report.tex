...
madsen            & Madsen \tocite                  & N/A                   & N/A          & 0.05            \\ \hline
smith s2.65 d0.1  & Smith et al \tocite             & 0.1                   & 2.65         & N/A       \\ \hline
smith s2.65 d0.78 & Smith et al \tocite             & 0.78                  & 2.65         & N/A       \\ \hline
smith s2.65 d0.01 & Smith et al \tocite             & 0.01                  & 2.65         & N/A       \\ \hline
smith 2.75 d0.01  & Smith et al \tocite             & 0.01                  & 2.75         & N/A       \\ \hline
smith s2.65 dvar  & Smith et al \tocite             & Spatial variable      & 2.65         & N/A       \\ \hline
\end{tabular}
\caption{Summary of the bottom friction configurations used in the experiments for PPB}
\end{table}

It has to be mentioned that Madsen \tocite and smith \tocite are dependent on different parameters. The key variable in Madsen \tocite is an equivalent roughness length scale of the bottom, kn whom default value is 0.05 m. In smith \tocite the two main variables are the specific gravity and the diamter grain size and their default values are 2.65 and 0.1 mm, respectively.
